...
self.addEventListener("fetch", function (event) {
    ...
    if (event.request.url.match(/wp-admin/) || event.request.url.match(/preview=true/) || event.request.url.match(/img-fotki.yandex.ru/) || event.request.url.match(/maps.googleapis.com/) || event.request.url.match(/disquscdn.com/)) {
        return;
    }
